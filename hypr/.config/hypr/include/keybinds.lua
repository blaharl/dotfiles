...
hl.bind(mainMod .. " + slash", dsp.layout("togglesplit")) -- dwindle only
...
hl.bind("ALT + SHIFT + period", dsp.exec_cmd("pypr change_workspace +1"))
hl.bind("ALT + SHIFT + comma", dsp.exec_cmd("pypr change_workspace -1"))
...
hl.bind("ALT + SHIFT + T", dsp.exec_cmd("~/.dotfiles/scripts/emacs_term.sh"))
